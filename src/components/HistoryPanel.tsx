    ...
    <>
      ...
      <div className="fixed top-0 right-0 bottom-0 z-50 w-80 bg-white dark:bg-gray-900 shadow-2xl flex flex-col border-l"
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b flex-shrink-0"
          style={{ borderColor: 'var(--border)' }}>
          <h2 className="text-sm font-semibold text-gray-800 dark:text-gray-200 dark:text-gray-700">Historique</h2>
          <button onClick={onClose} className="p-1 rounded hover:bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:text-gray-600">
            <X size={14} />
          </button>
        </div>
          ...
          {loading ? (
            ...
            <div className="py-2">
              {entries.map((entry, i) => {
                ...
                return (
                  <div key={entry.id} className="flex gap-3 px-4 py-2.5 hover:bg-gray-50 dark:bg-gray-800/50 transition-colors">
                    {/* Timeline dot */}
                    ...
                    <div className="flex-1 min-w-0 pb-1">
                      <p className="text-xs font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600">{meta.label}</p>
                      {entry.entityName && (
